...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    console.error(`Erro no BFF ao proxy arquivo ${fullPocketBaseFileUrl}:`, error);
    ...
    throw createError({
      statusCode: 500,
      statusMessage: `Erro interno no servidor ao servir o arquivo: ${error.message || 'Erro desconhecido.'}`,
    });
  }
});